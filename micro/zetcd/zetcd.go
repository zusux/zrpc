...
func (e *Etcd) Register() {
	...
	e.service = etcdv3.Service{Key: e.Prefix + e.ServerAddress, Value: e.ServerAddress}
...
func (e *Etcd) GrpcRequest(ctx context.Context, req interface{}, reqFactory sd.Factory) (response interface{}, err error) {
	...
	instancer, err := etcdv3.NewInstancer(e.client, e.Prefix, logger)
	if err != nil {
		return nil,err
	}
